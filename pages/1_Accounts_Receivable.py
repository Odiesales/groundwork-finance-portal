...
/* === STRONGER FIX for "Rank Top 25 by" label === */
...
.stSelectbox label span {
    ...
    text-shadow: 0 1px 2px rgba(0,0,0,0.6) !important; /* helps visibility */
}

/* Target by text content as backup */
label:contains("Rank Top 25 by") {
    color: #ffffff !important;
}
